...
tags: ['corpus ling', 'keyphrase', 'sotu']
output:
  blogdown::html_page:
    toc: yes
...
##Lastly - State of the Union Addresses
...
sotuAnn::cdr_sotu_ann %>%
  ...
  corpuslingr::clr_search_keyphrases(n=5, key_var ='lemma', flatten=TRUE,jitter=TRUE, remove_nums = TRUE, include = c("year","president"))%>%
  arrange(desc(year))%>%
  DT::datatable(class = 'cell-border stripe', rownames = FALSE,width="100%", escape=FALSE)
```
