...
description: 'A congressional election success story, and an introduction to an R data package with New Mexico general election returns.'
author: ''
date: '2018-12-01'
slug: new-mexico-general-elections-2018
output:
  blogdown::html_page:
    toc: true
    toc_depth: 2
...
viz <- plot_ly(
    ...
    layout(
      title = "Transitions in precinct-level vote types in NM-02",
