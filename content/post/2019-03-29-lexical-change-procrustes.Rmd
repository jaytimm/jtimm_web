...
This post builds on a guide available [here](https://github.com/jaytimm/google_ngrams_and_R) that codes through the sampling of Google n-gram data and building of historical word embeddings for the investigation of lexical semantic change.  Here, we consider (and unpack) some methods presented in @hamilton2016diachronic & @li2019macroscope for aligning historical matrices/embeddings and visualizing semantic change.
...
* Build term-feature matrices based on simple co-occurrence;  Word embeddings.  
