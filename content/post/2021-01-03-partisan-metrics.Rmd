...
link-citations: yes
description: 'Some spatial data analyses per #Election2020 in New Mexico.'
...
State House election results are made available here by Princeton University folks -- which is apart of a [larger ecosystem of tools/resources](https://gerrymander.princeton.edu/resources) for investigating gerrymandering.  Results are limited to lower houses for states with bicameral state legislatures.
